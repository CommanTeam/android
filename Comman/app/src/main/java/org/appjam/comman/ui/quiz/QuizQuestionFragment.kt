...
//    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        recyclerView = view.quiz_quizChoice_rv
        ...
        recyclerView?.adapter = QuizAdapter((activity as QuizActivity).quizInfoList[pagePosition])
        Log.i(TAG, "on View Created ${pagePosition}")
    }
...
//            itemView.quiz_choice_content_tv.text = quizInfoList[position].content
