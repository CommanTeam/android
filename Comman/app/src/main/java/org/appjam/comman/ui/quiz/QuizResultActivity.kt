...
class QuizResultActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private val lecList = mutableListOf<QuizResultActivity.QuizResultData>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        quizResultList = findViewById<View>(R.id.quizResult_list_view) as RecyclerView
    ...
    private inner class QuizResultAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: RecyclerView.ViewHolder?, position: Int) {
            if (holder?.itemViewType == ListUtils.TYPE_HEADER) {
                ...
                (holder as QuizResultActivity.ElemViewHolder).bind(position - 1)
            }
            else
